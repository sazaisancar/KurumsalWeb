...
namespace KurumsalWeb.Controllers
{
    public class BlogController : Controller
    {
        ...
        {
            ViewBag.KategoriID = new SelectList(db.Kategorii, "KategoriID", "KategoriAd");
            return View();
        }
        [HttpPost]
        [ValidateInput(false)]
        ...
        //Güncelleme ve güncelleme sonrası veri tabanında tekrardan güncelleme sağladığım yer
        ...
        { 
            ...
            ViewBag.KategoriID = new SelectList(db.Kategorii, "KategoriID", "KategoriAd" ,b.KategoriID);
        ...
        //silme işlemlerin sağlandığım yer
